...
=======
    ...
    public boolean checkOnSnake(int Destination){
        if (Destination==11 || Destination == 36 || Destination == 43 || Destination == 56 ||
                Destination == 76 || Destination == 81 || Destination == 90 || Destination == 94 || Destination == 97 || Destination == 99) {
            return true;
        }
        else{
            return false;
